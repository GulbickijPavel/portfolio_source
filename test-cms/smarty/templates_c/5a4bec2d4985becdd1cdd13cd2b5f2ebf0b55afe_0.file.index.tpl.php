<?php /* Smarty version 3.1.24, created on 2015-11-02 17:32:28
         compiled from "C:/wamp/www/portfolio.lt/test-cms/index.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:320765637901c9d4cb0_00804582%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a4bec2d4985becdd1cdd13cd2b5f2ebf0b55afe' => 
    array (
      0 => 'C:/wamp/www/portfolio.lt/test-cms/index.tpl',
      1 => 1446470432,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '320765637901c9d4cb0_00804582',
  'has_nocache_code' => false,
  'version' => '3.1.24',
  'unifunc' => 'content_5637901cacae64_32725961',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5637901cacae64_32725961')) {
function content_5637901cacae64_32725961 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '320765637901c9d4cb0_00804582';
?>
<!DOCTYPE html>
...
-->
        ...
        <div id="page-wrapper"  ng-controller="items">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#source">Source</a></li>
                <li><a data-toggle="tab" href="#view">View</a></li>
                <li><a data-toggle="tab" href="#edit" ng-click='go("php/generateControlPage.php?item=skills")'>Control</a></li>
             ...
             <div class="tab-content">
                ...
                <div id="edit" class="tab-pane fade">
                    <div>
                        ...
                        <ul>
                            <li ng-repeat="item in ToEdit">
                                <input class="form-group" type="text" name="{{item | json}}" value="{{item | json}}">
                            </li>
                        </ul>
